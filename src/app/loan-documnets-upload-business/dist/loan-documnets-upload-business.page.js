...
var LoanDocumnetsUploadBusinessTextPage = /** @class */ (function () {
    function LoanDocumnetsUploadBusinessTextPage(userAPI, loadingController, formBuilder, transfer, zone, router, service, http, toastCtrl, fileChooser, alertController, camera) {
        ...
        this.bankpayslips = [];
        this.emiStatements = [];
        this.actypeca = { bankname: '-', acnumber: '-', actype: 'CA' };
        this.actypeod = { bankname: '-', acnumber: '-', actype: 'OD' };
        this.actypesaving = { bankname: '-', acnumber: '-', actype: 'SAVING' };
        this.imageData = '';
                        ...
                        _this.zone.run(function () {
                            if (res.isSuccess) {
                                ...
                                if (_this.savedLoan.redirectto) {
                                    ...
                                    if (_this.segments == 'segmentSeven') {
                                    }
                                    else if (_this.segments == 'segmentNine') {
                                    }
                                    else {
                                        _this.nextSlide();
                                    }
                                    ...
                                    handler: function (alertData) {
                                        if (alertData.name.length == 0 || alertData.number.length == 0 || alertData.slimit.length == 0 || alertData.adlimit.length == 0 || alertData.From.length == 0 || alertData.To.length == 0) {
                                            ...
                                            _this.fileChooser.open({ "mime": "application/pdf" })
                                                ...
                                                var idproof = "turnoverstatements :" + alertData.name + "number :" + alertData.number + "slimit :" + alertData.slimit + "adlimit :" + alertData.adlimit + " FromDate:" + alertData.From + "EndDate:" + alertData.To;
                                                // regarding detailed description of this you cn just refere ionic 2 transfer plugin in official website
                                                var options1 = {
                                                    fileKey: 'file',
                                                    fileName: filename + '.pdf',
                                                        ...
                                                        _this.http.post(_this.service.getBackenEndUrl() + 'api/test', formdata).pipe()
                                                            ...
                                                            _this.zone.run(function () {
                                                                ...
                                                                if (res.isSuccess) {
                                                                    ...
                                                                    switch (actype) {
                                                                        case 'CA':
                                                                            _this.actypeca = { bankname: alertData.name, actype: actype, acnumber: alertData.number };
                                                                            break;
                                                                        case 'ODCC':
                                                                            _this.actypeod = { bankname: alertData.name, actype: actype, acnumber: alertData.number };
                                                                            break;
                                                                        case 'SAVING':
                                                                            _this.actypesaving = { bankname: alertData.name, actype: actype, acnumber: alertData.number };
                                                                            break;
                                                                        default:
                                                                            break;
                                                                    }
    ...
    LoanDocumnetsUploadBusinessTextPage = __decorate([
        core_1.Component({
