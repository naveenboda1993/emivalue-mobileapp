...
var PartnersBusinessPage = /** @class */ (function () {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (alertData) {
                                        if (alertData.name1.length == 0 || alertData.share.length == 0) {
                                            ...
                                            _this.http.get(_this.service.getBackenEndUrl() + 'Login/businessaddpartner/' + localStorage.getItem('id')
                                                + '/' + encodeURIComponent(_this.loanid)
                                                + '/' + encodeURIComponent(alertData.name1)
                                                + '/' + encodeURIComponent(alertData.share)).pipe()
    ...
    PartnersBusinessPage = __decorate([
        core_1.Component({
