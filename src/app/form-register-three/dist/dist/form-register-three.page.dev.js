...
function () {
  function FormRegisterThreePage(userAPI, formBuilder, transfer, toastCtrl, zone, router, service, loading, http, camera) {
    ...
    this.error_messages = {
      'password': [{
        ...
        type: 'maxlength',
        message: 'password length is strong.'
      }],
      'confirmpassword': [{
        type: 'required',
        message: 'password is required.'
      ...
      'mobile': [{
        ...
        type: 'minlength',
        message: 'Mobile Number at least 10 Digits'
      }]
    };
  ...
  FormRegisterThreePage.prototype.ngOnInit = function () {
    this.form = this.formBuilder.group({
      ...
      mobile: ['', forms_1.Validators.compose([forms_1.Validators.required, forms_1.Validators.minLength(10)])],
  ...
  FormRegisterThreePage.prototype.onSubmit = function () {
    var _this = this; // let loading =  this.loading.create();
    //  loading.present();
    // https://www.youtube.com/watch?v=FXpwVLiKowc
    // this.http.post('http://emivalue.snitchmedia.in/api/appadduser', this.form.value).pipe(


    this.http.post(this.service.getBackenEndUrl() + 'api/appadduser', this.form.value).pipe().subscribe(function (res) {
  ...
  FormRegisterThreePage = __decorate([core_1.Component({
