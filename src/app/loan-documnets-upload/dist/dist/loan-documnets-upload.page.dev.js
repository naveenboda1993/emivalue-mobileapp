...
var LoanDocumnetsUploadTextPage =
/** @class */
function () {
  ...
  LoanDocumnetsUploadTextPage.prototype.uploadFile = function () {
    ...
    if (isId) {
      ...
      if (this.isFileUpload) {
        ...
        imageData = this.UriFileUpload; // fileTransfer.upload(this.UriFileUpload, encodeURI('http://emivalue.snitchmedia.in/Login/apploanupload/' + this.loanid), options1)
        //   .then((data) => {
        //     // success
                ...
                handler: function handler(alertData) {
                  ...
                  if (alertData == undefined) {
                    ...
                    _this.fileChooser.open({
                      ...
                      var idproof = "payslips :" + alertData; // regarding detailed description of this you cn just refere ionic 2 transfer plugin in official website
                          ...
                          _this.http.post(_this.service.getBackenEndUrl() + 'api/test', formdata).pipe().subscribe(function (res) {
                            _this.zone.run(function () {
                              ...
                              if (res.isSuccess) {
                                ...
                                obj.from = uri; // obj.monthname = alertData.name1;
                                // obj.to = alertData.To;
  ...
  LoanDocumnetsUploadTextPage = __decorate([core_1.Component({
